...
namespace ML_in_netML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\wikipedia-detox-250-line-data.tsv.txt";
        private static string MODEL_FILEPATH = @"C:\Users\cfenc\AppData\Local\Temp\MLVSTools\ML in netML\ML in netML.Model\MLModel.zip";
